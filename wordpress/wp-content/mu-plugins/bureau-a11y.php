...
function bureau_a11y_render_buttons() {
	...
	<!-- VLibras (portal v7.8.0+): o loader cria o próprio host em shadow DOM e
	     auto-renderiza. O markup <div vw> e o new VLibras.Widget() do widget
	     antigo eram ignorados pelo loader novo desde 25/08/2026 — saíram em
	     2.13.0. O botão nativo fica escondido pelo CSS e o acesso é o card
	     "Libras" do painel, que chama window.VLibrasWidget.open(). -->
